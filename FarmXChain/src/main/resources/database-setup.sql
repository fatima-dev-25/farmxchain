...
-- Insert Sample Admin User (Email: admin@farmxchain.io, Password: Admin@123)
-- Password hash: $2b$10$S6VPxRlAKSN7eROrNDwYeOK9eJa/qg5vinmgU0Tpj9YrpKhFehrsy
INSERT INTO users (email, name, password, role, status, is_verified, created_at) VALUES 
('admin@farmxchain.io', 'Admin', '$2b$10$S6VPxRlAKSN7eROrNDwYeOK9eJa/qg5vinmgU0Tpj9YrpKhFehrsy', 'ADMIN', 'ACTIVE', TRUE, NOW());
